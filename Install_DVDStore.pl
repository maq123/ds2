...
{
	system("./ds2_create_cust $par1_Start $par2_End $par3_Fname $par4_DB_Size $par_Sys_Type > us_cust.csv");		
}
else   #Windows
{
	if($bln_IsCygwin == 1)  #Run through Cygwin Bash Shell
	{
		system("./ds2_create_cust.exe $par1_Start $par2_End $par3_Fname $par4_DB_Size $par_Sys_Type > us_cust.csv");	
	}
...
if(lc($^O) eq lc("linux"))   #If system on which perl script is executing is Linux
{
	system("./ds2_create_cust $par1_Start $par2_End $par3_Fname $par4_DB_Size $par_Sys_Type > row_cust.csv");		
}
else   #Windows
{
	if($bln_IsCygwin == 1)  #Run through Cygwin Bash Shell
	{
		system("./ds2_create_cust.exe $par1_Start $par2_End $par3_Fname $par4_DB_Size $par_Sys_Type > row_cust.csv");	
	}
	else	#Run through DOS shell
	{
		system("ds2_create_cust.exe $par1_Start $par2_End $par3_Fname $par4_DB_Size $par_Sys_Type > row_cust.csv");	
...
if(lc($^O) eq lc("linux"))   #If system on which perl script is executing is Linux
{
	system("./ds2_create_inv $par_n_Prod $par_Sys_Type > ../prod/inv.csv");		
}
else   #Windows
{
	if($bln_IsCygwin == 1)  #Run through Cygwin Bash Shell
	{
		system("./ds2_create_inv.exe $par_n_Prod $par_Sys_Type > ../prod/inv.csv");	
	}
	else  #Run through DOS Shell
	{
		system("ds2_create_inv.exe $par_n_Prod $par_Sys_Type > ../prod/inv.csv");	
...
if(lc($^O) eq lc("linux"))   #If system on which perl script is executing is Linux
{
	system("./ds2_create_prod $par_n_Prod $par_Sys_Type > prod.csv");		
}
else   #Windows
{
	if($bln_IsCygwin == 1)  #Run through Cygwin Bash Shell
	{
		system("./ds2_create_prod.exe $par_n_Prod $par_Sys_Type > prod.csv");	
	}
	else   #Run through DOS Shell
	{
		system("ds2_create_prod.exe $par_n_Prod $par_Sys_Type > prod.csv");	
